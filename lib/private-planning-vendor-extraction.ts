...
export function coercePrivatePlanningVendorCategory(category?: string | null): VendorCategory {
  ...
  const keywordMap: Array<[RegExp, VendorCategory]> = [
    ...
    [/bride.*dress|wedding.*dress|bridal.*gown|wedding.*gown/, "Bride wedding dress"],
    [/groom.*suit|menswear|tailor|tuxedo|tux\b/, "Groom Suit"],
    [/bridesmaid.*dress|azazie/, "Bridesmaid Dress"],
    [/bridesmaid|bridal.*party/, "Bridesmaid Other"],
    [/groom.*(?:ring|band)|wedding.*band.*groom/, "Wedding Band - Groom"],
    [/bride.*(?:ring|band)|wedding.*band.*bride|jewellery|jewelry/, "Wedding Band - Bride"],
